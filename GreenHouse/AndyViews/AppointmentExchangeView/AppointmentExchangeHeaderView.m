//
//  AppointmentExchangeHeaderView.m
//  AndyCoder
//
...
@interface AppointmentExchangeHeaderView()
...
@end
@implementation AppointmentExchangeHeaderView
+ (instancetype)headViewWithTableView:(UITableView *)tableView{
    static NSString *headIdentifier = @"header";
    
    AppointmentExchangeHeaderView *headView = [tableView dequeueReusableCellWithIdentifier:headIdentifier];
    if (headView == nil) {
        headView = [[AppointmentExchangeHeaderView alloc] initWithReuseIdentifier:headIdentifier];
    }
