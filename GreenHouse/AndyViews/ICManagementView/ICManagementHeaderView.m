...
@interface ICManagementHeaderView()
...
@end
@implementation ICManagementHeaderView

+ (instancetype)headViewWithTableView:(UITableView *)tableView{
    static NSString *headIdentifier = @"header";
    
    ICManagementHeaderView *headView = [tableView dequeueReusableCellWithIdentifier:headIdentifier];
    if (headView == nil) {
        headView = [[ICManagementHeaderView alloc] initWithReuseIdentifier:headIdentifier];
    }
